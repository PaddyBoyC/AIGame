...
namespace AIGame.source.Flocking
{
    internal class Bat : Entity
    {
        ...
        public Bat(Vector2 position, (Texture2D, Texture2D) spriteSheets, List<Bat> bats, Player player, Vector2? biasDirection = null)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            const float topMargin = 532;
            const float rightMargin = 900;
            const float bottomMargin = 860;
